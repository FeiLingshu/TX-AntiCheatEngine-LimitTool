...
> ## 目前反作弊组件会将限制行为定义为 `修改游戏客户端` ，在LOL测试环境下，会对游戏账号进行 `全区封禁5分钟` 的处罚，触发时机未知，触发频率未知</br></br>目前经过2天游戏，每天启动游戏2-3次，每次游戏时长2-4局，连续两天22:00-23:00间触发，共受到全区封禁处罚5min×2</br></br>目前没有解决办法，建议各位谨慎使用/不使用
