...
namespace SGuard64_LimitTool
{
    internal class Program
    {
        ...
        internal static void Main(string[] _)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    ProcessInfo pi = new ProcessInfo(null, null, corestate, processormask);
        ...
        private struct ProcessInfo
        {
            ...
            internal ProcessInfo(Process process1, Process process2, bool corestate, uint processormask)
            {
        ...
        private static Thread CheckLoop(ProcessInfo processinfo)
        {
            Thread thread = new Thread(() =>
            {
                ...
                do
                {
                    ...
                    Set(processinfo.process2, processinfo.corestate, processinfo.processormask);
                    GC.Collect();
                } while (Thread.CurrentThread.IsAlive);
            })
            { IsBackground = true };
